    ...
    foreach ($_SESSION["cart_item"] as $item){
        ...
        ?>
           <input type="hidden" value="<?php echo $item['quantity']; ?>" name="quantity[<?php echo $item['code']; ?>]">
                ...
                <td><a href="search-product.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                </tr>
                <?php
...
<div class="custom-control custom-radio mb-10">
<input type="radio" class="custom-control-input" id="customControlValidation4" name="paymentmode" value="KBZ Pay" required>
<label class="custom-control-label" for="customControlValidation4">KBZ pay</label>
</div>
</div>
<div class="col-md-6 mb-10">
